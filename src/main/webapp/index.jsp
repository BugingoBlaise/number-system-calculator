...
<form action="converterServlet" method="post" id="myform">
  ...
  <input type="submit" name="conversionType" value="Binary">
  <input type="submit" name="conversionType" value="Hexadecimal">
  <input type="submit" name="conversionType" value="Octal">
  <input type="submit" name="conversionType" value="Refresh">
  <h1>Result: </h1>
